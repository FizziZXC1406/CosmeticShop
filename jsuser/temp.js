...
function buildsHTML_SANPHAMTUONGTU(res) {
    ...
    for (var item in data) {
        ...
        html += `<div class="product" style="height: 400px">
                    <div class="cat-item">
                        <a href="" class="position-relative overflow-hidden mb-3" s
                        ...
                        <div style="justify-content: center; display: flex; margin-bottom: 30px">
                            <h6 title="${list.TENMH}" class="" 
                                style = "margin: 0 20px 0 20px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                            ${list.TENMH}
                            </h6>
                        </div>
